...
int main() {
    ...
    printf("orange mushroom perfect efficiency : %.2f \n", orangeMushroom.getPerfectEfficiencyEPM(characterStats));
    printf("orange mushroom perfect efficiency with average damage : %.2f \n", orangeMushroom.getAveragePerfectEfficiency(characterStats));
    HPTables::hpTables.clear();
    ...
    printf("green slime perfect efficiency: %.2f \n", greenSlime.getPerfectEfficiencyEPM(characterStats));
    printf("green slime perfect efficiency with average damage : %.2f \n", greenSlime.getAveragePerfectEfficiency(characterStats));
    HPTables::hpTables.clear();
